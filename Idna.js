...
(function(constructor,prototype){
  ...
  if(c<=0xffff){
   ...
   builder.push(String.fromCharCode(((c - 65536) & 1023) + 56320))
    ...
    constructor.DecompToBufferInternal = function(ch, compat, buffer, index) {
    ...
    prototype.DecompToBuffer = function(ch, compat, buffer, index) {
   ...
   prototype.Init = function(str, index, length, form) {
    ...
    constructor.NormalizeAndCheckString = function(charList, start, length, form) {
        var i = start;
